...
namespace Business.Implements.General
{
    public class GameTypes : IGameTypes
    {
        ...
        public GameTypes(IRepository<GameType> repository,
        ...
        public async Task<IResponseService> Add(GameType entity)
        {
            try
            {
        ...
        public async Task<IResponseService> Update(GameType entity)
        {
            try
            {
